          ...
          {businessCapabilities.map((cap) => {
            ...
            return (
              <motion.div
                ...
                className="group rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm transition-all duration-300 hover:border-[#7C3AED]/30 hover:bg-white/10 lg:p-8"
              >
                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[#7C3AED]/15 text-[#7C3AED] transition-colors duration-300 group-hover:bg-[#7C3AED] group-hover:text-white">
