...
const posts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: "Promotional products aren't just giveaways — they're one of the most cost-effective marketing channels available. We break down the data on recall, impressions, and revenue impact that every marketing manager should know.",
    date: "March 2026",
    readTime: "5 min read",
    category: "Industry Trends",
  ...
  },
  {
    ...
    excerpt: "From $10 event giveaways to $500 VIP hampers — how to allocate your branded merchandise budget across different client and staff relationships for maximum impact.",
    date: "March 2026",
    readTime: "6 min read",
  ...
  },
  {
    ...
    excerpt: "As workplace wellbeing moves centre stage, wellness-themed branded merchandise is becoming the go-to choice for staff appreciation and client gifting in 2026. Here's what's resonating.",
    date: "March 2026",
    readTime: "4 min read",
    category: "Corporate Gifts",
  ...
  },
  {
    ...
    excerpt: "Even well-intentioned branded merchandise can backfire. We've seen these five mistakes repeatedly — and we'll show you how to sidestep each one for campaigns that actually land.",
    date: "February 2026",
    readTime: "4 min read",
    category: "Industry Trends",
