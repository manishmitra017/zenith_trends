            ...
            {featured.map((post, i) => (
              ...
              >
                <div className="relative aspect-[16/8] overflow-hidden bg-slate-100">
                  ...
                  <span className="absolute left-4 top-4 rounded-full bg-[#2AB09C] px-3 py-1 text-xs font-semibold text-white">
                    {post.category}
                  </span>
                </div>
                <div className="p-6">
                  ...
                  <div className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-[#2AB09C]">
              ...
              >
                ...
                <div className="p-5">
                  <div className="mb-2 flex items-center gap-3 text-xs text-slate-400">
                    <span className="rounded-full bg-[#2AB09C]/10 px-2.5 py-0.5 text-xs font-semibold text-[#2AB09C]">
                      {post.category}
                    </span>
                    <span className="flex items-center gap-1"><Clock className="h-3 w-3" />{post.readTime}</span>
                  </div>
                  <h3 className="text-base font-bold text-slate-900 line-clamp-2 transition-colors group-hover:text-[#2AB09C]">
                    {post.title}
                  </h3>
                  <p className="mt-2 text-xs leading-relaxed text-slate-500 line-clamp-3">{post.excerpt}</p>
                  <div className="mt-3 flex items-center justify-between">
                    <span className="text-xs text-slate-400">{post.date}</span>
                    <span className="text-xs font-semibold text-[#2AB09C]">Read →</span>
                  </div>
                </div>
              </motion.article>
            ))}
